...
DATA_DIR = os.path.join(current_dir, "..", "data", "humanHead")


def generate_head_renders(num_views: int = 40, data_dir: str = DATA_DIR, azimuth_range: float = 180):
    """
    ...
    cow_mesh_files = [
        os.path.join(data_dir, fl) for fl in ("humanHead.obj", "humanHead.mtl", "humanHead_diffuse.jpg")
    ]
    ...
    # Load obj file
    obj_filename = os.path.join(data_dir, "humanHead.obj")
